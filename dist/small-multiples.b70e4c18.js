...
},{"d3-collection":"../node_modules/d3-collection/src/index.js","d3-selection":"../node_modules/d3-selection/src/index.js"}],"data/body.csv":[function(require,module,exports) {
module.exports = "/body.320df41e.csv";
},{}],"scripts/small-multiples.js":[function(require,module,exports) {
"use strict";
...
var svg = d3.select('#chart-change1').append('svg').attr('height', height + margin.top + margin.bottom).attr('width', width + margin.left + margin.right).append('g').attr('transform', 'translate(' + margin.left + ',' + margin.top + ')');
...
var yTooltip = d3.scaleLinear().domain([0, 100]).range([tipHeight, 0]); // Create our scales

var xPositionScale = d3.scaleLinear().range([0, width]);
var yPositionScale = d3.scaleLinear().domian([0, 200000]).range([height, 0]);
var line = d3.line().x(function (d) {
  return xPositionScale(d.date);
}).y(function (d) {
  return yPositionScale(+d.entries);
});
d3.csv(require('/data/body.csv')).then(ready).catch(function (err) {
  console.log(err);
});
...
},{"d3":"../node_modules/d3/index.js","d3-tip":"../node_modules/d3-tip/index.js","/data/body.csv":"data/body.csv"}]},{},["scripts/small-multiples.js"], null)
//# sourceMappingURL=/small-multiples.b70e4c18.js.map